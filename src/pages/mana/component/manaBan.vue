...
const urlB = ref('../../public/manaBanB.jpg')
const urlR = ref('../../public/manaBanR.jpg')
...
<template>
  <div class="ban" :class="{ban_blue: color == 'blue', ban_red: color == 'red', ban_gold: color == 'gold', ban_click: canDelete && props.order != -1, ban_click_focus: beChosen}" @click="choose">
    ...
    <el-image :src="urlB" v-if="props.genieName == '' && color == 'blue'" style="width: 70px;margin-top: 4px;margin-left: 2px">
    </el-image>
    <el-image :src="urlR" v-if="props.genieName == '' && color == 'red'" style="width: 70px;margin-top: 4px;margin-left: 2px">
    </el-image>
